    ...
    <div id="wrapper">
        <div id="login" class="animate form">
            <section class="login_content">
                ...
                <form method="POST" action="{{ url('/password_reset') }}" id="passwordValidationForm">
                    {{ csrf_field() }}
                    @if (session('error'))
                    ...
                    <div>
                        <input type="password" class="form-control" placeholder="Repetir Contraseña"  id="repeat_password" name="repeat_password" required="" />
                    </div>
                    <div class="alert alert-error" id="pw-message-error">
                        Ambas contraseñas deben ser iguales
                    </div>
                    <div>
                        <button class="btn btn-default submit" id="btncreatepassword" disabled>Guardar Contraseña</button>
                    </div>
                    <div class="clearfix"></div>
                </form>
                <!-- form -->
...
<script src="{{ URL::asset('js/intranetjs/users/password-reset.js')}}"></script>
