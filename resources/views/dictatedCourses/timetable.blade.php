    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <form action="{{route('register.dictatedCourses')}}" method="POST" class="form-horizontal" id="registerTimeTable" name="registerTimeTable" novalidate="true">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="totalA" class="form-control col-md-7 col-xs-12" name="totalA" type="number">
                            </div>
                        </div>
                        -->
