...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content">
        <form class="form-horizontal" novalidate="true" action="{{ route('save-cicle.enhacementPlan')}}" method="POST" id="formAcademic" name="formAcademic">
          ...
          <div class="row">
            <div class="col-md-9 col-sm-12 col-xs-12">
              ...
              <a class="btn btn-default pull-right" href="{{ route('new.enhacementPlan') }}">Cancelar</a>
            </div>
          </div>
        </form>
      </div>
