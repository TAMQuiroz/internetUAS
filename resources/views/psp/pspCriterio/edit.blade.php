		...
		<div class="panel panel-default">
			<div class="panel-heading">
		  	...
		  	<div class="panel-body">
		    	...
		    	{{Form::open(['route' => ['pspCriterio.update', $criterio->id], 'class'=>'form-horizontal', 'id'=>'formSuggestion'])}}
                    	...
                    	<div class="col-md-4 col-sm-6 col-xs-12">
	                        ...
	                        @if($procesos!=null)
	                            @foreach($procesos as $psp)
	                                @if($criterio->id_pspprocess == $psp->id)
	                                <option value="{{$psp->id}}" selected>{{$psp->Course->Nombre}}</option>
	                                @elseif($psp != null)
		    		...
		    		<div class="form-group">
		    			...
		    			<div class="col-xs-12 col-md-4">
		    				{{Form::text('nombre',$criterio->nombre,['class'=>'form-control', 'required', 'maxlength' => 50])}}
		    			</div>
		    		</div>
		    		...
		    		<div class="form-group">
		    			...
		    			<div class="col-xs-12 col-md-4">
		    				{{Form::number('peso',$criterio->peso,['class'=>'form-control', 'required','min'=>1])}}
		    			</div>
		    		</div>
