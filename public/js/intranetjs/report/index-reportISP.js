$(document).ready(function() {
    ...
    $('#investigator-search').keyup( function() {
       ...
       var that = this;
        ...
        var tableRowsClass = $('.table-list-search-investigator tbody tr');
        $('.search-sf').remove();
    ...
    $('#teacher-search').keyup( function() {
       var that = this;
        // affect all table rows on in systems table
        var tableBody = $('.table-list-search-teacher tbody');
        var tableRowsClass = $('.table-list-search-teacher tbody tr');
        $('.search-sf').remove();
        tableRowsClass.each( function(i, val) {
