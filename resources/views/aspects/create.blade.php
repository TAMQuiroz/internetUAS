...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form class="form-horizontal" novalidate="true" action="{{ route('save.aspects')}}" method="POST" id="formAcademic" name="formAcademic">
					...
					<div class="x_content">
						<div class="form-group">
				          ...
				          <div class="col-md-6 col-sm-6 col-xs-12">
		                      <select id="aspect_id" name="aspect_id" class="form-control col-md-7 col-xs-12" type="text" disabled='true' >
		                        @if($resultado==null)
						...
						<div class="row">
							<div class="col-md-9 col-sm-12 col-xs-12">
								...
								<a class="btn btn-default pull-right" href="{{ route('index.aspects') }}">Atras</a>
							</div>
						</div>
					</div>
				</form>
