    ...
    <head>
      ...
      <meta charset="utf-8">
    <!--Se usa un bootstrap.css personalizado ahora-->
    ...
    <!-- end link refs--> 
        ...
        <img src="{{ URL::asset('images/uas.png')}}" class="img-circle img-responsive center-block" width="80px" style="display: inline-block; float:right; margin: 10px 30px 0 0">
        <div class="title_right">
          <h1 style="margin-left:17px">University Accreditation System</h1>
        </div>

    		<div class="title_left">
    			<h3 style="margin-left:17px">Consolidado de Medición</h3>
          <h3 style="margin-left:17px">Periodo: {{$period->configuration->cycleAcademicStart->Descripcion.' - '.$period->configuration->cycleAcademicEnd->Descripcion}}</h3>
    		</div>
    	</div>
    				...
    				<div class="row">
    					<div class="col-md-12 col-sm-12 col-xs-12">
    	                        ...
    	                        @foreach($period->studentsResults as $stRsl)
    	                        	<p><strong>{{ $stRsl->Identificador }}. {{ $stRsl->Descripcion }}</strong></p>
    	                        	<div class="">
    									<table class="table table-bordered">
    										<thead>
    											...
    											<tr class="success">
    												...
    												<th rowspan="2" class="text-center col-md-3">Criterio</th>
    													...
    													@if($Acrt->IdCriterio == $crt->IdCriterio)
    														...
    														<tr>
    															...
    															@foreach($period->levels as $lvl)
    																@if($Clvl->IdNivelCriterio == $lvl->IdNivelCriterio)
