  ...
  <div class="page-title">
      ...
      <div class="title_left">
        <h3 style="margin-left:17px">Consolidado de Resultados de Medición</h3>
        <h3 style="margin-left:17px">Periodo: {{ $currentPeriod->cycleAcademicStart->Descripcion }} al {{ $currentPeriod->cycleAcademicEnd->Descripcion }}</h3>
      </div>
    </div>
                                                          ...
                                                          @for ($j = 0; $j <  sizeof($matrixLineDetail->criterions); $j++)
                                                              <tr>
                                                                  ...
                                                                  @for($y = 0; $y < sizeof($inYoRush) ; $y++)
                                                                      @if(!empty($superMatrixHolder[$y][$k]->aspectsDetail[$x][$j]->criterionsRating) && sizeof($superMatrixHolder[$y][$k]->aspectsDetail[$x][$j]->criterionsRating)>0)
