    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="alert alert-warning">
                <strong>Advertencia: </strong> No existe periodo activo.
            </div>
        </div>
    </div>
@else
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_content">
          <form action="#" method="POST" class="form-horizontal" novalidate="true">
                  ...
                  <td class=""> {{$stu->Codigo}} </td>
                    ...
                    @if($studentsResults != null)
                        @foreach($studentsResults as $stdRslt)
                            @foreach($stdRslt->aspects as $asp)
                                @foreach($asp->criterion as $crt)
                                    <td class="text-center aspect {{$asp->IdAspecto}}" hidden>
        ...
        <div class="row">
          <div class="col-md-9 col-sm-12 col-xs-12">
            @if($progress == 100)
              <a href="{{ route('finish.myCourses', ['id' => $timeTable->IdHorario]) }}" class="btn btn-success pull-right"> Terminar</a>
            @endif
            <a href="{{ route('tableEdit.myCourses', ['id' => $timeTable->IdHorario]) }}" class="btn btn-success pull-right" id="edit"> Editar</a>
