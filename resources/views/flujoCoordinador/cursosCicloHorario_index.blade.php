...
@section('content')
                ...
                <form action="{{route('save.courses')}}" method="POST" class="form-horizontal" id="viewCourse" name="viewCourse">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="courseName" class="form-control col-md-7 col-xs-12" name="courseName" type="text" readonly="true" value="{{$course->Nombre}}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <a href="{{ route('cursosCicloHorario_create.flujoCoordinador', ['id' => $idEspecialidad,'courseId' => $course->IdCurso]) }}" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Agregar Horario</a>
                            </div>                                         
                        </div>  
                                ...
                                @foreach($timetablexteacher as $txt)
                                    <tr class="even pointer">
                                        ...
                                        <td class="text-center" style="vertical-align: middle">
                                            ...
                                            <a href="{{ route('cursosCicloHorario_edit.flujoCoordinador', ['id' => $idEspecialidad,'courseId' => $course->IdCurso, 'timetableId' => $txt[0]->timetable->IdHorario])}}" class="btn btn-primary btn-xs" title="Editar"><i class="fa fa-pencil"></i></a>
                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12 col-xs-12">
                                ...
                                <a href="{{ route('cursosCiclo_index.flujoCoordinador', ['id' => $idEspecialidad]) }}" class="btn btn-default pull-right">Aceptar</a>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script src="{{ URL::asset('js/intranetjs/flujoCoordinador/cursosxciclo-horarios.js')}}"></script>
