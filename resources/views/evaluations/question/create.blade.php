								...
								<div class="col-md-8 col-sm-8 col-xs-4">
									<div class="input-group">										
										...
										<span class="input-group-addon">
											<input class="tCerr" type="radio" disabled value="a" name="rpta" >
										</span>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-10 col-xs-6">
									<div class="input-group">										
										...
										<span class="input-group-addon">
											<input class="tCerr" type="radio" disabled value="b" name="rpta" >
										</span>
									</div>
								</div>
							</div>
...
<script>
	...
	$(".tCerr").click(function() {
		var rpta = $('input[name=rpta]:checked').val();
		alert(rpta);
	});
