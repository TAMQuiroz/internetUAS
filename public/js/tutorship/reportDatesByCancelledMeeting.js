$(function () {
    ...
    // Build the chart  
    var canceladas  = $("#canceladas_report").attr("value");    
    var dataComplete = [];    
    var i = 0;
    $(".table tbody tr").each(function (index) 
        {
            ...
            $(this).children("td").each(function (index2) 
            {
                switch (index2) 
                {
                    case 1: name = $(this).text();
                            break;
                    case 2: amount = $(this).text();
                            break;
                    case 3: percentage = $(this).text();
                            break;
                }               
            })            
            dat.name = name;
    ...
    $('#graphic_cancelled').highcharts({    
        ...
        title: {
            text: 'Reporte gráfico - Total citas: ' + canceladas  
        },
        tooltip: {
