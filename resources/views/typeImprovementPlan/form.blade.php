...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<form action="{{ route('save.typeImprovement')}}" method="POST" id="formTypeImprovement" name="formTypeImprovement" novalidate="true" class="form-horizontal">
			...
			<div class="x_content">
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input class="form-control col-md-7 col-xs-12" type="text" name="code" id="code" required="true">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input class="form-control col-md-7 col-xs-12" type="text" name="theme" id="theme" required="true">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<textarea class="resizable_textarea form-control" id="description" name="description" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: vertical; height: 80px;"></textarea>
					</div>
				</div> 
