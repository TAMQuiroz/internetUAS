...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_content">
				<form class="form-horizontal" novalidate="true" action="{{ route('save.suggestions')}}" method="POST" id="formSuggestion" name="formSuggestion">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<textarea class="form-control col-md-7 col-xs-12" id="description" name="description" rows="4" required="true" style="resize: vertical;"></textarea>
						</div>
					</div>
					<div class="separator"></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select class="form-control col-md-7 col-xs-12" name="improvementPlan" id="improvementPlan">
								...
								@foreach($improvementPlans as $plans)
                              		<option value="{{$plans->IdPlanMejora}}">{{$plans->Descripcion}}</option>
                         		@endforeach
                         		@endif
							</select>
						</div>
