        ...
        <table class="table table-striped responsive-utilities jambo_table bulk_action">
            ...
            <tbody>
                ...
                <tr class="even pointer">
                    ...
                    <td class=" ">
                        @if(!$student->trashed())
                        <a href="{{route('mis_alumnos.show',$student->id)}}" class="btn btn-primary btn-xs view-group">
                            <i class="fa fa-search"></i>
                        </a>
                        <a href="{{route('cita_alumno.create',$student->id)}}" class="btn btn-primary btn-xs view-group">
