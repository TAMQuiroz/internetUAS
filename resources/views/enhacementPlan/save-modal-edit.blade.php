<div class="modal fade" role="dialog" id="cicleModalEdit">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <form class="form-horizontal" role="form" action="{{ route('saveModalNewEdit.enhacementPlan')}}" method="POST" id="formAcademic2" name="formAcademic2">
                                ...
                                <div class="form-horizontal">
                                  ...
                                  <div class="row">
                                    <div class="col-md-9 col-sm-12 col-xs-12">
                                      ...
                                      <a class="btn btn-default submit" href="{{ route('edit.enhacementPlan') }}">Cancel</a>
                                    </div>
                                  </div>
