<div class="remodal" data-remodal-id="{{$id}}" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
      ...
      @if($cita->estado == 4 && $cita->creador == 0)
      ...
      @else
      <p style="font-size: 18px"><strong>Cancelar cita</strong></p>
      <p style="font-size: 16px">Esta a punto de cancelar esta cita, indique el motivo</p>
      @endif
  	</div>
