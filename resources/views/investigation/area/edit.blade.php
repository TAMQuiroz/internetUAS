		    	...
		    	{{Form::open(['route' => ['area.update', $area->id], 'class'=>'form-horizontal', 'id'=>'formSuggestion'])}}
		    		<div class="form-group">
		    			...
		    			<div class="col-xs-12 col-md-4">
		    				{{Form::text('nombre',$area->nombre,['class'=>'form-control', 'required', 'maxlength' => 200])}}
		    			</div>
		    		</div>
		    		...
		    		<div class="form-group">
		    			...
		    			<div class="col-xs-12 col-md-4">
		    				{{Form::text('descripcion',$area->descripcion,['class'=>'form-control', 'required', 'maxlength' => 2000])}}
		    			</div>
		    		</div>
