<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true"  id="modal-group">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Detalle Grupo de Investigación</h4>
      </div>
      <div class="modal-body">
        <div class="row" style="margin-top: 10px;">
        	...
        	<div class="col-md-3 col-sm-3 col-xs-12" id="group-id"></div>
      		</div>
      	</div>
      	...
      	<div class="row" style="margin-top: 10px;">
        	...
        	<div class="col-md-3 col-sm-3 col-xs-12" id="group-name"></div>
      		</div>
      	</div>
